...
This PA is due on ** **Thursday, November 12 at 11:59pm** **
...
The header comments in the WebPartitioners serve as the written part of your grade for this PA.
...
On the Gradescope assignment **Programming Assignment 5 - code** please submit the following file structure:
...
* *pa5-starter*
    * *src*
        * *ucsdcse12pa5student*
            ...
            * CounterExample.java
            * Partitioner.java
            * WebPartitioner1.java
            * WebPartitioner2.java
            * WebPartitioner3.java
